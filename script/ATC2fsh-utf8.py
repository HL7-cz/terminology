...
# fsh_lines.append('* ^contact[0].name = "Národní centrum elektronického zdravotnictví"')
# fsh_lines.append('* ^contact[0].telecom[0].system = #url')
# fsh_lines.append('* ^contact[0].telecom[0].value = "https://ncez.mzcr.cz"')
# fsh_lines.append('* ^contact[0].telecom[1].system = #email')
# fsh_lines.append('* ^contact[0].telecom[1].value = "
fsh_lines.append('')
