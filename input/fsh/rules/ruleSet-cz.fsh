...
* ^url = "https://hl7.cz/terminology/ValueSet/{resourceId}"

RuleSet: setUrl_ncez ( resourceId )
* ^url = "https://ncez.mzcr.cz/terminology/ValueSet/{resourceId}"

RuleSet: setUrl_sukl ( resourceId )
* ^url = "https://sukl.cz/terminology/ValueSet/{resourceId}"
