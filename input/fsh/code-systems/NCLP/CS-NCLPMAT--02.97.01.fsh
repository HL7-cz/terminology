...
Id: NCLPMAT
Title: "NCLPMAT"
Description: "Číselník materiálů pro laboratoře"
* ^language = #cs
...
* ^status = #active
* ^experimental = false
* ^date = "2026-05-14T14:46:49.834711Z"
* ^publisher = "MZČR"
//* ^effectivePeriod.start = "2026-05-14T00:00:00Z"
* ^caseSensitive = false
* ^content = #complete
* ^property[0].code = #klic
...
* #B(F) "Krev fetální"
* #B(F) ^property[0].code = #klic
* #B(F) ^property[=].valueString = "B(F)"
* #B(F) ^property[+].code = #kod
* #B(F) ^property[=].valueString = "B(F)"
* #B(F) ^property[+].code = #kodl
* #B(F) ^property[=].valueString = "B(F)"
* #B(F) ^property[+].code = #n24
* #B(F) ^property[=].valueString = "B(fet.)"
* #B(F) ^property[+].code = #n32
* #B(F) ^property[=].valueString = "B(fet.)"
* #B(F) ^property[+].code = #n32l
* #B(F) ^property[=].valueString = "B(fet.)"
* #B(F) ^property[+].code = #n55
* #B(F) ^property[=].valueString = "Krev fetální"
* #B(F) ^property[+].code = #n55l
* #B(F) ^property[=].valueString = "Krev fetální"
* #B(F) ^property[+].code = #plati_od
* #B(F) ^property[=].valueDateTime = "2026-05-03T00:00:00Z"
* #B(F) ^property[+].code = #poradi
* #B(F) ^property[=].valueString = "010601"
* #B(N) "Krev nativní"
...
* #CELLS "Buňky"
* #CELLS ^property[0].code = #klic
* #CELLS ^property[=].valueString = "CELLS"
* #CELLS ^property[+].code = #kod
* #CELLS ^property[=].valueString = "CELLS"
* #CELLS ^property[+].code = #kodl
* #CELLS ^property[=].valueString = "CELLS"
* #CELLS ^property[+].code = #n24
* #CELLS ^property[=].valueString = "Buňky"
* #CELLS ^property[+].code = #n32
* #CELLS ^property[=].valueString = "Buňky"
* #CELLS ^property[+].code = #n32l
* #CELLS ^property[=].valueString = "Buňky"
* #CELLS ^property[+].code = #n55
* #CELLS ^property[=].valueString = "Buňky"
* #CELLS ^property[+].code = #n55l
* #CELLS ^property[=].valueString = "Buňky"
* #CELLS ^property[+].code = #plati_od
* #CELLS ^property[=].valueDateTime = "2026-03-02T00:00:00Z"
* #CELLS ^property[+].code = #poradi
* #CELLS ^property[=].valueString = "901900"
* #CEREB "Mozek"
...
* #MECON "Mekónium"
* #MECON ^property[0].code = #klic
* #MECON ^property[=].valueString = "MECON"
* #MECON ^property[+].code = #kod
* #MECON ^property[=].valueString = "MECON"
* #MECON ^property[+].code = #kodl
* #MECON ^property[=].valueString = "MECON"
* #MECON ^property[+].code = #n24
* #MECON ^property[=].valueString = "Mekónium"
* #MECON ^property[+].code = #n32
* #MECON ^property[=].valueString = "Mekónium"
* #MECON ^property[+].code = #n32l
* #MECON ^property[=].valueString = "Mekónium"
* #MECON ^property[+].code = #n55
* #MECON ^property[=].valueString = "Mekónium"
* #MECON ^property[+].code = #n55l
* #MECON ^property[=].valueString = "Mekónium"
* #MECON ^property[+].code = #plati_od
* #MECON ^property[=].valueDateTime = "2000-01-01T00:00:00Z"
* #MECON ^property[+].code = #poradi
* #MECON ^property[=].valueString = "090500"
* #MENIN "Meningy"
...
* #SKINDER "Kožní deriváty"
* #SKINDER ^property[0].code = #klic
* #SKINDER ^property[=].valueString = "SKINDER"
* #SKINDER ^property[+].code = #kod
* #SKINDER ^property[=].valueString = "SKINDER"
* #SKINDER ^property[+].code = #kodl
* #SKINDER ^property[=].valueString = "SKINDER"
* #SKINDER ^property[+].code = #n24
* #SKINDER ^property[=].valueString = "Kožní deriváty"
* #SKINDER ^property[+].code = #n32
* #SKINDER ^property[=].valueString = "Kožní deriváty"
* #SKINDER ^property[+].code = #n32l
* #SKINDER ^property[=].valueString = "Kožní deriváty"
* #SKINDER ^property[+].code = #n55
* #SKINDER ^property[=].valueString = "Kožní deriváty"
* #SKINDER ^property[+].code = #n55l
* #SKINDER ^property[=].valueString = "Kožní deriváty"
* #SKINDER ^property[+].code = #plati_od
* #SKINDER ^property[=].valueDateTime = "2025-10-01T00:00:00Z"
* #SKINDER ^property[+].code = #poradi
* #SKINDER ^property[=].valueString = "186500"
...
* #STOMCONT "Žaludeční obsah"
* #STOMCONT ^property[0].code = #klic
* #STOMCONT ^property[=].valueString = "STOMCONT"
* #STOMCONT ^property[+].code = #kod
* #STOMCONT ^property[=].valueString = "STOMCONT"
* #STOMCONT ^property[+].code = #kodl
* #STOMCONT ^property[=].valueString = "STOMCONT"
* #STOMCONT ^property[+].code = #n24
* #STOMCONT ^property[=].valueString = "Žaludeční obsah"
* #STOMCONT ^property[+].code = #n32
* #STOMCONT ^property[=].valueString = "Žaludeční obsah"
* #STOMCONT ^property[+].code = #n32l
* #STOMCONT ^property[=].valueString = "Žaludeční obsah"
* #STOMCONT ^property[+].code = #n55
* #STOMCONT ^property[=].valueString = "Žaludeční obsah"
* #STOMCONT ^property[+].code = #n55l
* #STOMCONT ^property[=].valueString = "Žaludeční obsah"
* #STOMCONT ^property[+].code = #plati_od
* #STOMCONT ^property[=].valueDateTime = "2000-01-01T00:00:00Z"
* #STOMCONT ^property[+].code = #poradi
* #STOMCONT ^property[=].valueString = "094100"
* #SW "Pot"
...
* #VAGBLOOD ^property[=].valueString = "800100"
...
* #VAGCERPO ^property[=].valueString = "800110"
...
* #VAGCONT ^property[=].valueString = "800120"